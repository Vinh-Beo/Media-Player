...
class Play_music_ofline : Activity(), MediaPlayer.OnCompletionListener, SeekBar.OnSeekBarChangeListener {
    ...
    private var btn_pause: ImageButton? = null
...
//        songProgressBar!!.setOnSeekBarChangeListener(this@Play_music_ofline) // Important
        mymediaplayer!!.setOnCompletionListener(this@Play_music_ofline)
